    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_user', models.ForeignKey(on_delete=models.SET(base_app.models.get_unknown_user), related_name='sizemodel_create_user', to=settings.AUTH_USER_MODEL, verbose_name='資料創建者')),
                ('updated_user', models.ForeignKey(on_delete=models.SET(base_app.models.get_unknown_user), related_name='sizemodel_updated_user', to=settings.AUTH_USER_MODEL, verbose_name='資料最後更新者')),
            ],
            options={
                'db_table': 'size',
            },
