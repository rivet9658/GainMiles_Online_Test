"""
Django settings for GainMiles_Online_Test project.
...
SECRET_KEY = 'django-insecure-q3ey#ai0$s9qm6%s!iu+xjh#sehek^(7q5=ijfuczc#hlxsx7@'
...
ROOT_URLCONF = 'GainMiles_Online_Test.urls'
CORS_URLS_REGEX = r"^/.*"
CORS_ALLOW_HEADERS = [
    "Accept",
    "content-type",
...
WSGI_APPLICATION = 'GainMiles_Online_Test.wsgi.application'
